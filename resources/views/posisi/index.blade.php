...
@section('title')
    <title>Daftar Posisi Aset</title>
@endsection
    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">                      
                        <h1 class="m-0 text-dark">Manajemen Posisi Aset</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="/home">Home</a></li>
                            <li class="breadcrumb-item active">Posisi Aset</li>
                        </ol>
                    </div>
                </div>
            </div>
                                        ...
                                        <td class="text-center">
                                            <form action="{{ route('aset.destroy', $p->id) }}" method="POST">
                                                ...
                                                <input type="hidden" name="_method" value="DELETE">
                                                    <div class="btn-group">
                                                        <a class="btn btn-success btn-sm" href="{{ route('aset.edita', $p->id) }}"><i class="fa fa-edit"></i></a>
