                                        ...
                                        <td class="text-center">
                                            <form action="{{ route('letak.destroy', $p->id) }}" method="POST">
                                                ...
                                                <input type="hidden" name="_method" value="DELETE">
                                                    <div class="btn-group">
                                                        <a class="btn btn-info btn-sm" href="{{ route('letak.show', $p->id) }}"><i class="fa fa-eye"></i></a>
                                                        <a class="btn btn-success btn-sm" href="{{ route('letak.edit', $p->id) }}"><i class="fa fa-edit"></i></a>
